...
import { github, linkedIn } from "./index";
    ...
    <section className="w-full px-8 py-12 flex flex-col gap-16 md:items-center justify-between md:flex-row md:px-20 md:py-24">
      ...
      <div className=" flex flex-col text-center md:text-left md:w-1/2">
        ...
        <div className="flex justify-center md:items-center md:justify-start gap-5">
          <a href='https://github.com/Niranjan-webdev' target='_blank' rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-gray-200 hover:bg-[#2dd4bf] flex items-center justify-center transition-colors duration-200 group">
          ...
          <a href='https://www.linkedin.com/in/niranjan-g2k/' target='_blank' rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-gray-200 hover:bg-[#2dd4bf] flex items-center justify-center transition-colors duration-200 group">
