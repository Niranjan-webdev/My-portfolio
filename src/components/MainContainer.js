        ...
        <>
            ...
            <section id="home" className='w-full'>
                ...
                {width >= 768 ? (<div className='socialmedia__bar ml-[1.3rem] fixed top-[40%] flex md:flex-col flex-col gap-6 w-[32px]'>
                    <a href='https://github.com/Niranjan-webdev' target='_blank'><img src={github} /></a>
                    <a href='https://www.linkedin.com/in/niranjan-g2k/' target='_blank'><img src={linkedIn} /></a>
                    {/* <a><img src={DevTo} /></a> */}
                    <a href="mailto:niranjan.g2k@gmail.com" target="_blank"><img src={mail} /></a>
                </div>) : ""}
