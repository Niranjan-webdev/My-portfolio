            ...
            <section className='w-full'>
                ...
                <div className='hero__banner h-[calc(100vh-100px)] flex items-center justify-around px-[5rem] py-[3rem] md:flex flex-wrap gap-4'>
                    <div className='banner__content w-3/5'>
                        ...
                        <h2 className='text-4xl mb-4 font-bold'>I'm <span className='border-b-2 border-[#713cdd]'>Niranjan Govinthan</span></h2>
                        <h1 className='text-6xl mb-6 font-bold bg-gradient-to-r from-[#713cdd] to-[#1d2734] text-transparent bg-clip-text'>FULLSTACK-DEVELOPER</h1>
                        <p className='text-xl mb-10 font-semibold'>Focused on  <span className='text-[#713cdd]'>React</span>,  <span className='text-[#713cdd]'>Svelte</span>, <span className='text-[#713cdd]'>JavaScript</span>, <span className='text-[#713cdd]'>TypeScript</span>, and <span className='text-[#713cdd]'>Node.js</span>. I craft fast, accessible interfaces and build scalable, maintainable backend systems.</p>
                        <button className='py-4 px-6 bg-[#713cdd] hover:bg-[#79cdb9] rounded-[12px] text-white text-base font-bold'>MORE ABOUT ME</button>
                    </div>
                    <Terminal />
                </div>
            </section>
            ...
            <section className=' about__me flex bg-[#f1f5f9]'>
                <div className='about__container w-full py-[7rem] flex items-center justify-around'>
                    ...
                    <div className='about__content w-1/2'>
                        <h4 className='text-xl font-bold text-[#713cdd] mb-6'>— ABOUT ME</h4>
                        <h2 className='text-5xl text-[#713cdd] mb-6 font-bold'><span className='text-black'>I'm</span> Niranjan</h2>
