            ...
            <section className='w-full'>
                ...
                <div className='hero__banner h-[calc(100vh-100px)] flex items-center justify-around px-[5rem] py-[3rem] md:flex flex-wrap gap-4'>
                    <div className='banner__content w-3/5'>
                        ...
                        <p className='text-xl mb-10 font-semibold'>Focused on  <span className='text-[#2eb89c]'>React</span>,  <span className='text-[#2eb89c]'>Svelte</span>, <span className='text-[#2eb89c]'>JavaScript</span>, <span className='text-[#2eb89c]'>TypeScript</span>, and <span className='text-[#2eb89c]'>Node.js</span>. I craft fast, accessible interfaces and build scalable, maintainable backend systems.</p>
