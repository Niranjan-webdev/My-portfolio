    ...
    return (
        <>
            ...
            <section className='w-full'>
                ...
                {/* Social media bar */}
                <div className='hero__banner min-h-screen flex items-center justify-around px-[5rem] py-[3rem] md:flex flex-wrap gap-4'>
            ...
            <section className=' about__me flex'>
                <div className='about__container w-full py-[7rem] flex items-center justify-around md:py-[4rem]'>
