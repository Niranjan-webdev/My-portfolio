    ...
    return (
        <>
            ...
            <section className='w-full'>
                {/* Social media bar */}
                <div className='socialmedia__bar ml-[2.7rem] fixed top-[40%] flex md:flex-col flex-col gap-6 w-[32px]'>
                    <a><img src={github} /></a>
                ...
                <div className='hero__banner h-[calc(100vh-100px)] flex items-center justify-around px-[5rem] py-[3rem] md:flex flex-wrap gap-4'>
                    <div className='banner__content w-3/5'>
                        ...
                        <p className='text-xl mb-10 font-semibold'>Focused on <span className='text-[#2eb89c]'>JavaScript</span>, <span className='text-[#2eb89c]'>TypeScript</span>, <span className='text-[#2eb89c]'>React</span>, and <span className='text-[#2eb89c]'>Node.js</span>. I craft fast, accessible interfaces and build scalable, maintainable backend systems.</p>
            ...
            <section className=' about__me flex bg-[#f1f5f9]'>
                <div className='about__container w-full py-[7rem] flex items-center justify-around'>
                    ...
                    <div className='about__content w-1/2'>
                        ...
                        <p className='text-xl font-[500]'>Fullstack developer focused on React, TypeScript, and Node.js. I specialize in building robust React frontends and scalable Node.js APIs that simplify complex data operations. Outside of coding, I play electric guitar, enjoy video games, and love exploring new technologies.</p>
                    </div>
                </div>
