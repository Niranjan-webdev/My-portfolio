...
function Contact() {
  ...
  return (
    <>
    <section className="w-full px-8 py-12 flex flex-col gap-16 md:items-center justify-between md:px-20 py-24">

      {/* ── Left side ── */}
      <div className=" flex flex-col text-center md:flex-row w-1/2">
