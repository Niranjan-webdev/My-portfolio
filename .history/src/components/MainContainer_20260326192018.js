        ...
        <>
          <FloatingTags/>
            ...
            <section className='w-full'>
                ...
                {/* Social media bar */}
                <div className='hero__banner min-h-screen flex flex-col md:flex-row items-center justify-around px-6 md:px-[1rem] py-[3rem] gap-8'>
                <div className='banner__content w-full md:w-1/2 flex flex-col items-center md:items-start'>
