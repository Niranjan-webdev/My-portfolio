  ...
  return (
    <div className="w-full px-16 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <h2 className="text-4xl font-bold italic text-[#2eb89c] mb-3">Tech Stack</h2>
        <p className="text-2xl text-gray-800 font-medium">Powering my day-to-day development work</p>
      </div>
