        ...
        <>
          <FloatingTags/>
            ...
            <section className='w-full'>
                ...
                {/* Social media bar */}
                <div className='hero__banner min-h-screen flex flex-col md:flex-row items-center px-[3rem] md:justify-around  md:px-[3rem] py-[3rem] gap-8'>
                    <div className='banner__content w-full flex flex-col items-center md:items-start '>
